...
(function (factory) {
  ...
  var range = (function () {
    ...
    /**
     * return boundaryPoint from TextRange, inspired by Andy Na's HuskyRange.jq
     *
  ...
  */
   ...
   *  mouse events that show/hide popover will be handled by Handle.jq.
   *  Handle.jq will receive the events and invoke 'imagePopover.update'.
   */
